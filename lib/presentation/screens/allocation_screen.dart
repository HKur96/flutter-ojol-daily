...
class AllocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Alokasi Uang & Pos Tabungan"),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Sisa Uang Bebas Saat Ini", style: TextStyle(fontSize: 12, color: AppColors.onSurfaceVariant)),
            ...
            const Text("Daftar Pos Alokasi Kewajiban", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
            ...
            state.obligationSummaries.isEmpty
                ? const Center(
                    child: Padding(
                      ...
                      child: Text("Belum ada kewajiban dibuat. Tambahkan kewajiban di menu Kewajiban."),
                    ),
                  )
                : ListView.builder(
                    shrinkWrap: true,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Dialokasikan: ${currencyFormat.format(ob.allocatedAmount)}", style: const TextStyle(fontSize: 12, color: AppColors.onSurfaceVariant)),
                                  Text("${ob.allocationProgressPercent.toStringAsFixed(0)}% terkumpul", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.primary)),
                                ],
                              ),
                              const SizedBox(height: 8),
          ...
          builder: (context, setState) {
            return Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Sisihkan Uang ke Pos Alokasi", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
                  const SizedBox(height: 16),
                  DropdownButtonFormField<String>(
                    value: selectedObligationId,
                    decoration: const InputDecoration(labelText: "Pilih Tujuan Kewajiban"),
                    items: provider.state.obligationSummaries
                        .map((o) => DropdownMenuItem(value: o.id, child: Text("${o.name} (Sisa target: ${o.remainingAmount})")))
                        .toList(),
                    onChanged: (val) => setState(() => selectedObligationId = val!),
                  ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Nominal Alokasi (Maks Rp ${provider.state.freeCash})",
                      prefixText: "Rp ",
                    ),
                  ),
